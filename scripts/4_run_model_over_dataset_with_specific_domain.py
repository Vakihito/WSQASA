# -*- coding: utf-8 -*-
"""4 - run model over dataset with specific domain.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EFvfkRXeWVNPGkr9z5jBohFcgy4qKot7

## Run model over dataset

---

In this notebook we execute the finetuned model over the dataset.

---

#### **Inputs**

The input of this notebook will be `{dataset_name}_validation_with_pol.pkl` with the following data:
...
And also the model that we created on `3 - training the QA model on syntatic data.ipynb` named `{dataset_name}_finetuned_{domain}_model`

---

#### **Output**

The output of this notebook will be `{dataset_name}_validation_{domain}_with_finetuned_predictions.pkl` with the following data:
