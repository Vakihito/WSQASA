# -*- coding: utf-8 -*-
"""2 - similarity search answers artificial df.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12qY8FvEDBmyKZqCGu0SJcFfQEYQj0h9K

## Notebook for sentiment classification

---

Fazer grupos associados à sentimentos por meio do modelo de classificação de sentimentos

---

#### **Input**

The input of this notebook will be `{dataset_name}_artificial.pkl` with the following data:
